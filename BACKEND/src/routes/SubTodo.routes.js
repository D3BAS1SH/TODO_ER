...
import {AddSubTodo,DeleteSubtodo,UpdateSubTodo,BatchAddSubtodos,BatchUpdateSubtodos,ToggleCompletion} from "../controllers/subtodo.controller.js";
...
SubTodoRouter.route('/toggle-subtodo/:subtodoid').patch(verifyJWT,ToggleCompletion);
